    ...
    <div className="animate-pulse">
      <div className="mb-2 flex items-center ">
        ...
        <div className="flex flex-col gap-2 p-6">
          <div className="h-5 w-96 rounded-full bg-muted"></div>
          <div className="h-3.5 w-72 rounded-full bg-muted"></div>
          <div className="h-3 w-60 rounded-full bg-muted"></div>
        </div>
      </div>
      <div className="mb-8 h-[4.5rem] w-full rounded-md bg-muted"></div>
      <div className="mb-6 flex items-center justify-between">
        <div className="h-7 w-12 rounded-full bg-muted"></div>
      ...
      <div className="flex items-end justify-between">
        ...
        {/* <div className="h-96 w-60 rounded-md bg-muted"></div> */}
